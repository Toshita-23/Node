...
function setUser(user){ 
    return jwt.sign({_id: user._id, email: user.email}, secret); // here we have only user so we used user object as a playload direct we have single value if we have mtliple value then we use like below
